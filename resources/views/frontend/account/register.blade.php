    ...
    <form class="form" action="" method="POST">
      ...
      <div class="flex-column">
        ...
        <div class="inputForm">
          ...
          <input placeholder="Enter your Name" class="input" type="text" value="{{old('name',request()->name ?? '')}}" name="name">
         
        </div>

        @error('name')
        <span class="text-danger" style="color: red;font-style: italic">{{$message}}</span> 
    @enderror
        ...
        <div class="flex-column">
          ...
          <div class="inputForm">
            ...
            <input placeholder="Enter your Email" class="input" type="text"value="{{old('email',request()->email ?? '')}}" name="email">
